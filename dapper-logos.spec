...
%description
The dapper-logos package contains various image files which can be
used by the bootloader, anaconda, and other related tools.

%package httpd
Summary: Dapper Linux-related icons and pictures used by httpd
...
%description httpd
The dapper-logos-httpd package contains image files which can be used by
httpd.
...
# Fix syslinux-splash not found error
